...
arduino uno controller, and then outputted on a 16-line LCD in 4-bit mode. Supports standard alphanumeric characters, spaces and punctuation. 
...
Therefore only 4 pins are used—putting the LCD in 4bit mode which required splitting the bits as seen in code. 

The LED is simply for visual feedback/debuggingof morse input. 

↓↓ Reference Image Below ↓↓

![Example Circuit](reference.jpg)
![Example Circuit](examplevid.mp4)
